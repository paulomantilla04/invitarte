...
const Dashboard = () => {
    ...
    const userName = (session?.user.user_metadata.displayName?.split(" ")[0]) || "Usuario";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <main className="flex flex-col items-center justify-center w-full p-6 mt-16">
            <motion.h1 className="text-2xl lg:text-5xl font-montserrat font-extrabold text-black mb-4" initial={{ opacity: 0, x: 25 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.1 }}>
